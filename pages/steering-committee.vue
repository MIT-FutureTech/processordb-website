<template>
    <div class="text-gray-800">
        ...
        <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-32 mb-16 mt-16">
            <!-- Team section - hidden for now, can be re-enabled in the future -->
            <!-- <section>
...
<script setup>
useHead({
    title: 'Steering Committee - MIT Processor DB',
    meta: [
        {
            name: 'description', content: 'MIT Processor DB Steering Committee members'
        }
    ],
    htmlAttrs: {
        lang: 'en',
