  ...
  <div class="text-gray-800">
      ...
      <div class="flex flex-col items-center justify-center">
        <div class="flex flex-col items-center justify-center text-center">
          ...
          <p class="text-lg sm:text-xl md:text-2xl">
            Revealing Technical and Economic Trends in Computer Hardware
          </p>
        </div>
        ...
        <div class="mt-8 flex flex-col items-center justify-center relative">
          <p class="font-medium bg-white/70 p-2 text-center">
            Stay informed about our launch and other
            updates!<br>Sign up to get notified.
          </p>
          <form @submit.prevent="submitEmail" class="flex gap-2">
            <input class="border-[#A32035] border text-gray-800 text-sm py-2 px-4 rounded-xl mt-4" type="email"
              placeholder="Enter your email" v-model="email">
            <!-- honeypot -->
            <input type="text" name="b_3f8c3e3d3c" tabindex="-1" value="" class="hidden">
            <button class="bg-[#A32035] text-white py-2 px-4 rounded-xl hover:opacity-90 mt-4" :disabled="submitting">
              Subscribe
            </button>
          </form>
          ...
          <div v-for="(member, index) in team" :key="index">
            <NuxtLink :to="`/team#${member.name.replace(' ', '-').toLowerCase()}`"
              ...
              <div class="flex flex-col items-center justify-center">
                ...
                <p class="font-medium text-gray-700 text-center mt-4">
                  {{ member.name }}
                </p>
                <p class="text-xs text-[#A32035] text-nowrap">
                  {{ member.affiliation }}
                </p>
              </div>
            </NuxtLink>
    ...
    <footer class="bg-black border-t-[12px] border-t-[#A32035] text-center text-white py-8 px-4 sm:px-6 lg:px-8 ">
      <div class="max-w-7xl mx-auto flex justify-between flex-col gap-8 lg:flex-row flex-wrap">
        <div class="text-left">
          <h2 class="text-2xl font-bold font-logo">
            <span class="text-[#A32035]">MIT</span> <span class="text-nowrap">PROCESSOR DB</span>
          </h2>
          <p class="text-sm">
            Revealing Technical and Economic Trends in Computer Hardware
          </p>
        ...
        <div class="flex justify-between text-left flex-col gap-8 lg:gap-32 lg:flex-row  ">
          <div>
            ...
            <ul class="font-light text-sm space-y-2 mt-2">
              <li>
                <a class="hover:underline py-2" href="https://futuretech.mit.edu/" target="_blank"
          ...
          <div>
            ...
            <ul class="font-light text-sm space-y-2 mt-2">
              <li>
                <a class="hover:underline py-2" href="http://cpudb.stanford.edu/" target="_blank"
                  aria-label="Stanford CPU DB">Stanford
                  CPU DB</a>
              </li>
              <li>
                <a class="hover:underline py-2" href="https://chip-dataset.vercel.app/" target="_blank"
                  aria-label="The CHIP Dataset">The
                  CHIP Dataset</a>
              </li>
              <li>
                <a class="hover:underline py-2" href="https://www.techpowerup.com/cpu-specs/" target="_blank"
                  aria-label="TechPowerUp">TechPowerUp</a>
              </li>
              <li>
                <a class="hover:underline py-2" href="https://en.wikichip.org/wiki/WikiChip" target="_blank"
                  aria-label="TechPowerUp">WikiChip</a>
              </li>
            </ul>
          </div>
          <!-- <div>
