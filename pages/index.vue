                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-5 gap-16 mt-8">
                    ...
                    <div v-for="(member, index) in team" :key="index">
                        <div class="flex flex-col items-center justify-centerrounded-full">
                            <img :src="member.image" class="w-1/2" alt="team member">
                ...
                <div class="flex justify-between text-left flex-col gap-8 lg:gap-20 lg:flex-row  ">
                    <div>
                        ...
                        <ul class="font-light text-sm space-y-2 mt-2">
                            <li><a class="hover:underline" href="#">MIT Futuretech</a></li>
                            <li><a class="hover:underline" href="#">Koomey Analytics</a></li>
                        </ul>
                    </div>
                    <div>
                        <h4 class="font-bold text-md">Data sources</h4>
                        <ul class="font-light text-sm space-y-2 mt-2">
                            <li><a class="hover:underline" href="#">Stanford CPU DB</a></li>
                            <li><a class="hover:underline" href="#">The CHIP Dataset</a></li>
                            <li><a class="hover:underline" href="#">TechPowerUp</a></li>
                            <li><a class="hover:underline" href="#">WikiChip</a></li>
                        </ul>
                    </div>
                    <div>
...
const team = [
    {
        name: 'Andrew Lucas Guedes de Souza',
