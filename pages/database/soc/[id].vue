                ...
                <div class="space-y-8 flex-1">
                  ...
                  <div>
                    <ul class="space-y-2">
                      ...
                      <li class="pl-4"><strong>Process Size (nm):</strong> {{ gpu.architecture_info.process_size || '-' }}</li>
                    </ul>
                  </div>
                  ...
                  <div>
                    <ul class="space-y-2">
                      ...
                      <li class="pl-4"><strong>Memory Bandwidth (GB/s):</strong> {{ gpu.memory_info.memory_bandwidth || '-' }}</li>
                    </ul>
                  </div>
                ...
                <div class="space-y-8 flex-1">
                  ...
                  <div>
                    <ul class="space-y-2">
                      ...
                      <li class="pl-4"><strong>Texture Rate (GTexel/s):</strong> {{ gpu.compute_info.texture_rate || '-' }}</li>
                      <li class="pl-4"><strong>FP16 (half) Performance (TFLOPS):</strong> {{ gpu.compute_info.fp16 || '-' }}</li>
                      <li class="pl-4"><strong>FP32 Performance (TFLOPS):</strong> {{ gpu.compute_info.fp32 || '-' }}</li>
                      <li class="pl-4"><strong>FP64 (double) Performance (GFLOPS):</strong> {{ gpu.compute_info.fp64 || '-' }}</li>
                      <li class="pl-4"><strong>Shader Units (SU):</strong> {{ gpu.compute_info.shader_units || '-' }}</li>
                      <li class="pl-4"><strong>Texture Mapping Units (TMUs):</strong> {{ gpu.compute_info.texture_mapping_units ||
                        '-'
                        }}
                      </li>
                      <li class="pl-4"><strong>Render Output Units (ROPs):</strong> {{ gpu.compute_info.render_output_units || '-' }}
                      </li>
                    </ul>
                  </div>
                  ...
                  <div>
                    <ul class="space-y-2">
                      ...
                      <li class="pl-4"><strong>Pixel Rate (GPixel/s):</strong> {{ gpu.graphic_api_info.pixel_rate || '-' }}</li>
                      ...
                      <li class="pl-4"><strong>Vertex Shader:</strong> {{ gpu.graphic_api_info.vertex_shader || '-' }}</li>
                    </ul>
                  </div>
                </div>
              </div>
