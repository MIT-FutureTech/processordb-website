              ...
              <div class="space-y-8 flex-1">
                ...
                <div>
                  <ul class="space-y-2">
                    ...
                    <li class="pl-4"><strong>FP16 Performance (GFLOPS):</strong> {{ gpu.compute_info.fp16 || '-'
                      }}</li>
                    <li class="pl-4"><strong>FP32 Performance (GFLOPS):</strong> {{ gpu.compute_info.fp32 || '-' }}</li>
        ...
        <table class="min-w-full bg-white shadow rounded-lg text-left text-sm">
          ...
          <tbody>
            <tr v-for="benchmark in benchmarks" :key="benchmark.benchmark_id">
              ...
              <td class="py-2 px-4 border-b">{{ benchmark.score + ' GFLOP'}}</td>
            </tr>
          </tbody>
        </table>
      </section>
