        ...
        <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-32 mb-16 mt-16">
            ...
            <section>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-16 mt-8 place-content-center place-items-center">
                    <a href="https://futuretech.mit.edu/" target="_blank" aria-label="MIT Futuretech">
                        <img src="/MIT Futuretech - new transparent  (3).png" class="max-h-[200px]" alt="MIT Futuretech">
                    </a>
                    <a href="https://www.koomey.com/analyticspage.html" target="_blank" aria-label="Koomey Analytics">
                        <img src="/koomeyanalyticslogo.png" class="max-h-[200px]" alt="Koomey Analytics">
                    </a>
                </div>
            </section>
        </main>
