...
__name(setDevToolsClientUrl, "setDevToolsClientUrl");
...
__name(getDevToolsClientUrl, "getDevToolsClientUrl");
...
__name(onRpcConnected, "onRpcConnected");
...
__name(onRpcSeverReady, "onRpcSeverReady");
...
__name(VueDevToolsVuePlugin, "VueDevToolsVuePlugin");
function createDevToolsStateContext() {
  ...
  __name(getDevToolsState$1, "getDevToolsState$1");
  return {
...
__name(createDevToolsStateContext, "createDevToolsStateContext");
function useDevToolsState() {
  return inject(VueDevToolsStateSymbol);
}
__name(useDevToolsState, "useDevToolsState");
var fns = [];
...
__name(refreshCurrentPageData, "refreshCurrentPageData");
export {
