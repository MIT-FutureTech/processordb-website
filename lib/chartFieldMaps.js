...
// Maps all available fields from CPU, GPU, FPGA, AI Processor, and SoC models
...
export const fpgaNumericFields = [
  { value: 'release_year', label: 'Release Year', source: 'fpga' },
  ...
  { value: 'equivalent_lut_count', label: 'Equivalent LUT Count', source: 'fpga' },
];
...
export const fpgaCategoricalFields = [
  ...
  { value: 'product_name', label: 'Product Name', source: 'fpga' },
  { value: 'logic_resource_type', label: 'Logic Resource Type', source: 'fpga' },
  { value: 'internal_operating_voltage', label: 'Internal Operating Voltage', source: 'fpga' },
...
export const socNumericFieldsForFPGA = [
  { value: 'release_year', label: 'Release Year', source: 'soc' },
  { value: 'process_node', label: 'Process Node (nm)', source: 'soc' },
  { value: 'die_sizes', label: 'Die Size (mm²)', source: 'soc' },
  { value: 'total_transistor_count', label: 'Total Transistor Count', source: 'soc' },
  { value: 'transistor_density', label: 'Transistor Density', source: 'soc' },
...
// AI Processor numeric/date fields for axes
export const aiProcessorNumericFields = [
  { value: 'performance_tops', label: 'Performance (TOPS)', source: 'aiProcessor' },
  { value: 'clock_rate_ghz', label: 'Clock Rate (GHz)', source: 'aiProcessor' },
  { value: 'tdp_w', label: 'TDP (W)', source: 'aiProcessor' },
  { value: 'die_size_mm2', label: 'Die Size (mm²)', source: 'aiProcessor' },
  { value: 'process_node_nm', label: 'Process Node (nm)', source: 'aiProcessor' },
  { value: 'sram_mb', label: 'SRAM (MB)', source: 'aiProcessor' },
  { value: 'sram_bandwidth_tbs', label: 'SRAM Bandwidth (TB/s)', source: 'aiProcessor' },
  { value: 'dram_gb', label: 'DRAM (GB)', source: 'aiProcessor' },
  { value: 'dram_bandwidth_gbs', label: 'DRAM Bandwidth (GB/s)', source: 'aiProcessor' },
  { value: 'peak_bw_gbs', label: 'Peak Bandwidth (GB/s)', source: 'aiProcessor' },
  { value: 'release_year', label: 'Release Year', source: 'aiProcessor' },
];

// AI Processor categorical fields for group by
export const aiProcessorCategoricalFields = [
  { value: 'model_name', label: 'Model Name', source: 'aiProcessor' },
  { value: 'company', label: 'Company', source: 'aiProcessor' },
  { value: 'product_name', label: 'Product Name', source: 'aiProcessor' },
  { value: 'country', label: 'Country', source: 'aiProcessor' },
  { value: 'precision', label: 'Precision', source: 'aiProcessor' },
  { value: 'format', label: 'Format', source: 'aiProcessor' },
  { value: 'cloud_edge', label: 'Cloud/Edge', source: 'aiProcessor' },
  { value: 'workload_type', label: 'Workload Type', source: 'aiProcessor' },
  { value: 'networking', label: 'Networking', source: 'aiProcessor' },
  { value: 'units', label: 'Units', source: 'aiProcessor' },
];

// SoC numeric/date fields available to AI Processor
export const socNumericFieldsForAIProcessor = [
  { value: 'release_date', label: 'Release Date', source: 'soc' },
  { value: 'process_node', label: 'Process Node (nm)', source: 'soc' },
  { value: 'die_sizes', label: 'Die Size (mm²)', source: 'soc' },
  { value: 'total_transistor_count', label: 'Total Transistor Count', source: 'soc' },
...
// SoC categorical fields available to AI Processor
export const socCategoricalFieldsForAIProcessor = socCategoricalFieldsForCPU;
...
export const fieldMaps = {
  ...
  aiProcessor: {
    numeric: [...aiProcessorNumericFields, ...socNumericFieldsForAIProcessor],
    categorical: [
      ...aiProcessorCategoricalFields,
      ...socCategoricalFieldsForAIProcessor,
      { value: 'manufacturer_name', label: 'Manufacturer', source: 'soc' },
    ],
  },
  soc: {
...
export const generateNumericOptionsFromData = (data, processorType = 'cpu', excludes = []) => {
  ...
  const excludeSet = new Set([
    ...
    'cpu_id', 'gpu_id', 'fpga_id', 'ai_processor_id', 'soc_id', 'manufacturer_id',
...
export const generateCategoricalOptionsFromData = (data, processorType = 'cpu', excludes = []) => {
  ...
  const excludeSet = new Set([
    ...
    'source', 'usage', 'performance_metrics', // AI Processor text fields that are too long for categorical
    ...excludes
  ]);
