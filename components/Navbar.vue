      ...
      <div class="justify-end">
        <div class="flex items-center justify-end gap-6">
          <div class="menu-item has-dropdown relative group">
            <a href="#" class="menu-item-link flex items-center gap-2">
              ...
              <svg width="13" height="9"
                ...
                <path d="M0.5 1L6.5 7.5L12.5 1" stroke="currentColor" stroke-linecap="round"></path>
              </svg>
            </a>
            <div
          ...
          <NuxtLink to="/team" class="text-white hover:text-[#A32035] flex items-center">
            Team
          </NuxtLink>
          <NuxtLink to="/team#steering-committee" class="text-white hover:text-[#A32035] flex items-center">
            Steering committee
          </NuxtLink>
        </div>
      </div>
